...
import type { Producto, Categoria, Banner, CrearProductoDTO, ActualizarProductoDTO, Pedido, PedidoDetalleAdmin, FacturaConProblema } from '../types';
...
type Tab = 'productos' | 'categorias' | 'carteleria' | 'pedidos' | 'importar_precios' | 'facturas';
  ...
  return (
    <div className="admin-page">
      ...
      <div className="admin-tabs">
        ...
        <button
          className={`admin-tab ${tabActiva === 'carteleria' ? 'admin-tab--activa' : ''}`}
          onClick={() => setTabActiva('carteleria')}
        >
          Cartelería
        </button>
        <button
